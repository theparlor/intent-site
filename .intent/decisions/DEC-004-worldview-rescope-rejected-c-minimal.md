...
## Update 2026-06-05 — Consequences item 2 (ECOSYSTEM §6 "deprecating") RESOLVED

The Consequences note above ("§6 still calls intent-site 'deprecating'") is **resolved**. `Core/ECOSYSTEM-ARCHITECTURE-2026-05-20.md` §6 (line 240) now reads "evolves in place into the Intent + Throughline / system-plane surface … NOT deprecated" (canon-cited: SIG-INTENTSITE-2026-04-23; DEC-004; WS-DDR-107). The lagging founding three-tier spec §7 (`Core/products/parallax/spec/2026-04-23-three-tier-umbrella-and-ecosystem-design.md` line 147) was aligned in the same pass — closing the "spec §7 revision pending" item the canon signal logged. ROADMAP TASK-10.6 closed. One open follow-up: a consistency-audit catch-net to prevent re-introduction. See `.intent/signals/SIG-EXEC-2026-06-05-ecosystem-deprecation-correction.md`.
